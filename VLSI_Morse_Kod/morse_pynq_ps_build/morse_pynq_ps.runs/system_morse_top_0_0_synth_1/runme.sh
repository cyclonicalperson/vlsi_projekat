...
HD_PWD='C:/Users/Pavle/Downloads/vlsi_projekat/VLSI_Morse_Kod/morse_pynq_ps_build/morse_pynq_ps.runs/system_morse_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_morse_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_morse_top_0_0.tcl
